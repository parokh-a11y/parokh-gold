...
/* v2.0.4 — public site: no login/register icons */
function parokhUpdateAuthNav(){
  document.querySelectorAll(
    "header a[href='login.html'], header a[href='/login'], header a[href='register.html'], " +
    "header a.nav-login-graphic, header a.nav-user-link, header a.btn-power[data-auth], " +
    "header a[data-i18n='nav_login'], header a[data-i18n='nav_panel'], header a[href='dashboard.html']"
  ).forEach(function(a){
    if (a.hasAttribute("data-dash-header") || a.closest("[data-dash-header]")) return;
    if (document.body.classList.contains("page-dashboard") || /admin\.html/i.test(location.pathname)) return;
    a.remove();
  });
  document.querySelectorAll(
    "footer a[href='login.html'], footer a[href='register.html'], footer a[href='dashboard.html'], " +
    "footer a[data-i18n='nav_login'], footer a[data-i18n='nav_panel']"
  ).forEach(function(a){
    a.remove();
  });
  document.querySelectorAll(".mobile-nav a[href='login.html'], .mobile-nav a[href='register.html'], .mobile-nav a[href='dashboard.html']").forEach(function(a){
    a.remove();
  });
}
