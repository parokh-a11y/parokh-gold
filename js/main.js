...
function parokhUpdateAuthNav(){
  var logged = false;
  try {
    if (localStorage.getItem("parokh_session")) logged = true;
  } catch(e){}
  document.querySelectorAll('a[href="login.html"], a[href="/login"], a[href="login"]').forEach(function(a){
    if (logged) {
      a.href = "dashboard.html";
      var fa = document.body.classList.contains("rtl");
      a.textContent = fa ? "پنل من" : "My Panel";
