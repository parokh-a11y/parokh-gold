...
/* v2.0.1 site chatbot — load once */
(function(){
  if (window.__parokhChatLoading) return;
  if (document.querySelector('script[src*="parokh-chat.js"]')) return;
  if (document.body && (document.body.classList.contains("page-admin") || /admin\.html/i.test(location.pathname))) return;
  window.__parokhChatLoading = true;
  var s = document.createElement("script");
  s.src = "js/parokh-chat.js";
  s.defer = true;
