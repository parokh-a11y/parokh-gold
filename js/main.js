...
function parokhUpdateAuthNav(){
  ...
  document.querySelectorAll("header a[href='login.html'], header a[href='/login'], header a.nav-login-graphic, header a.nav-user-link, header a.btn-power[data-auth], header a[data-i18n='nav_login']").forEach(function(a){
    if (logged) {
  ...
  document.querySelectorAll("footer a[href='login.html'], footer a[data-i18n='nav_login']").forEach(function(a){
    a.classList.remove("nav-login-graphic", "btn-power");
    if (logged) {
      a.href = "dashboard.html";
      a.textContent = isFa ? "پنل من" : "My Panel";
    } else {
