...
function parokhUpdateAuthNav(){
  ...
  // Header only: text or graphic login / panel / power
  document.querySelectorAll("header a[href='login.html'], header a[href='/login'], header a.nav-login-graphic, header a.nav-user-link, header a.btn-power[data-auth]").forEach(function(a){
    if (logged) {
  ...
  // Footer / elsewhere: always restore text Login / Panel (never graphic)
