...
(function () {
  ...
  if (demoForm) {
    demoForm.addEventListener("submit", async function (e) {
      ...
      try {
        var r = /* payment V1 wired after order */ await fetch("/api/orders", {
          method: "POST",
...
function showPaymentPanel(pay) {
  ...
  if (qr && pay.wallet_address) {
    qr.src = "https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=" + encodeURIComponent(pay.wallet_address);
    qr.alt = "QR " + pay.wallet_address;
  }
